...
# static fields
.field static final a:Landroid/support/v4/widget/g;
...
.field private final d:Landroid/support/v4/widget/f;
...
.field private final i:Landroid/support/v4/widget/bd;

.field private final j:Landroid/support/v4/widget/bd;

.field private final k:Landroid/support/v4/widget/m;

.field private final l:Landroid/support/v4/widget/m;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/f;

    const/high16 v0, -0x67000000

    iput v0, p0, Landroid/support/v4/widget/DrawerLayout;->f:I

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->h:Landroid/graphics/Paint;
    ...
    iput v1, p0, Landroid/support/v4/widget/DrawerLayout;->e:I
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/m;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/m;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/m;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bd;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bg;)Landroid/support/v4/widget/bd;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    invoke-virtual {v1, v3}, Landroid/support/v4/widget/bd;->a(I)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/bd;->a(F)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/m;

    iget-object v2, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/m;->a(Landroid/support/v4/widget/bd;)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/m;

    invoke-static {p0, v4, v1}, Landroid/support/v4/widget/bd;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/bg;)Landroid/support/v4/widget/bd;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Landroid/support/v4/widget/bd;->a(I)V

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/bd;->a(F)V

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->l:Landroid/support/v4/widget/m;

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/m;->a(Landroid/support/v4/widget/bd;)V
    ...
    sget-object v0, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/g;
...
.method public a(I)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->A:Ljava/lang/CharSequence;
...
.method public a(II)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    :goto_1
    invoke-virtual {v0}, Landroid/support/v4/widget/bd;->e()V
    ...
    :cond_4
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;
...
.method a(IILandroid/view/View;)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bd;->a()I

    move-result v2

    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    invoke-virtual {v3}, Landroid/support/v4/widget/bd;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/j;

    if-eqz v0, :cond_2

    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/j;

    invoke-interface {v0, v1}, Landroid/support/v4/widget/j;->a(I)V
...
.method a(Landroid/view/View;F)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/widget/j;->a(Landroid/view/View;F)V
...
.method a(Z)V
    ...
    iget-object v7, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;
    ...
    invoke-virtual {v7, v5, v6, v8}, Landroid/support/v4/widget/bd;->a(Landroid/view/View;II)Z
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;
    ...
    invoke-virtual {v6, v5, v7, v8}, Landroid/support/v4/widget/bd;->a(Landroid/view/View;II)Z
    ...
    :cond_3
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->k:Landroid/support/v4/widget/m;
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/DrawerLayout;->d:Landroid/support/v4/widget/f;
...
.method b(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/j;->b(Landroid/view/View;)V
...
.method c(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/j;->a(Landroid/view/View;)V
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bd;->a(Z)Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    invoke-virtual {v1, v4}, Landroid/support/v4/widget/bd;->a(Z)Z
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/widget/bd;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/widget/bd;->b()I
...
.method public h(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroid/support/v4/widget/bd;->a(Landroid/view/View;II)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    invoke-virtual {v3, p1}, Landroid/support/v4/widget/bd;->a(Landroid/view/MotionEvent;)Z

    move-result v3

    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->j:Landroid/support/v4/widget/bd;

    invoke-virtual {v4, p1}, Landroid/support/v4/widget/bd;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v5, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    float-to-int v0, v0

    float-to-int v4, v4

    invoke-virtual {v5, v0, v4}, Landroid/support/v4/widget/bd;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v4/widget/bd;->d(I)Z
...
.method protected onMeasure(II)V
    ...
    sget-object v10, Landroid/support/v4/widget/DrawerLayout;->a:Landroid/support/v4/widget/g;

    iget-object v11, p0, Landroid/support/v4/widget/DrawerLayout;->B:Ljava/lang/Object;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/widget/k;->getSuperState()Landroid/os/Parcelable;
    ...
    :cond_0
    iget v0, p1, Landroid/support/v4/widget/k;->b:I

    const/4 v1, 0x3

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/DrawerLayout;->a(II)V

    iget v0, p1, Landroid/support/v4/widget/k;->c:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Landroid/support/v4/widget/k;-><init>(Landroid/os/Parcelable;)V
    ...
    iput v0, v1, Landroid/support/v4/widget/k;->a:I

    :cond_0
    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->p:I

    iput v0, v1, Landroid/support/v4/widget/k;->b:I

    iget v0, p0, Landroid/support/v4/widget/DrawerLayout;->q:I

    iput v0, v1, Landroid/support/v4/widget/k;->c:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/bd;->b(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroid/support/v4/widget/DrawerLayout;->i:Landroid/support/v4/widget/bd;

    float-to-int v5, v0

    float-to-int v6, v3

    invoke-virtual {v4, v5, v6}, Landroid/support/v4/widget/bd;->d(II)Landroid/view/View;
    ...
    invoke-virtual {v4}, Landroid/support/v4/widget/bd;->d()I
...
.method public setDrawerListener(Landroid/support/v4/widget/j;)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/DrawerLayout;->t:Landroid/support/v4/widget/j;
